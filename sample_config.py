...
cc_mapping = False #boolean: enable mapping cc changes to midi note, use for mapping damper pedal to kick drum. Only work with switch type pedal (only on and off)
cc_list = {64:(64,0,"C2",100)} #dict: map cc changes to midi note. ccnumber:(on_threshold, off_threshold, note, velocity)
